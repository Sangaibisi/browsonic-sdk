...
| 3   | S5     | 2026-04-29      | browsonic-react         | **Yayın gate'i**: `NPM_TOKEN` repository secret'ını [Sangaibisi/browsonic-react](https://github.com/Sangaibisi/browsonic-react) settings'inde tanımla. Yoksa release.yml main push'unda fail eder ve `@browsonic/react@0.1.0` yayınlanmaz. Token rotation cadence SDK token ile aynı.                                                                                                                                   | pending | repo-owner        | —             |
